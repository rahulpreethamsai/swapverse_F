...
export async function getItemIdController(req, res) {
    try {
...
export async function getMyItemsController(req, res) {
    try {
...
export async function postItemsController(req, res) {
    try {
...
export async function putItemIdController(req, res) {
    try {
        const { id } = req.params;
...
export async function deleteItemIdController(req, res) {
    try {
        const { id } = req.params;
        const item = await Item.findById(id);
        if (!item)
