...
export async function newSwapRequest(req: any, res: Response) {
    try {
...
export async function getUsersSwapsController(req: any, res: Response) {
    try {
...
export async function swapAccepted(req: any, res: Response) {
    try {
        const swap = await Swap.findById(req.params.id);

        if (!swap) return res.status(404).json({ message: "No Swap Found", success: false });
...
export async function swapCancelled(req: any, res: Response) {
    try {
        const swap = await Swap.findById(req.params.id);
...
export async function swapPickedUp(req: any, res: Response) {
    try {
        const swap = await Swap.findById(req.params.id);
...
export async function swapReturned(req: any, res: Response) {
    try {
        const swap = await Swap.findById(req.params.id);
        if (!swap) return res.status(404).json({ message: "Swap not found" });
...
export async function swapRaisedDispute(req: any, res: Response) {
    try {
        const swap = await Swap.findById(req.params.id);
        if (!swap) return res.status(404).json({ message: "Swap not found" });
...
export async function swapFinished(req: any, res: Response) {
    try {
        const swap = await Swap.findById(req.params.id);
        if (!swap) return res.status(404).json({ message: "Swap not found" });
